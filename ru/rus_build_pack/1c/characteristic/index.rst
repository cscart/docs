...
Способ загрузки характеристик задается в настройках модуля "Русская локализация - Экспорт, импорт в 1С".
...
После ввода всех необходимых данных. Пройдите в настроенный узел обмена и нажмите на кнопку "Синхронизация данных" - "Выполнить обмен данными". (см. https://www.cs-cart.ru/docs/4.1.x/rus_build_pack/1c/instruction/).
...
Способ загрузки характеристик задается в поле "Способы отображения характеристик из 1С" настроек модуля "Русская локализация - Экспорт, импорт в 1С" во вкладке "Настройка параметров и опций".
