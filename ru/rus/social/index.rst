...
.. list-table::
    ...
    *   -   Loginza
        ...
        -   Требуется регистрация на сервисе loginza.ru . В настоящий момент регистрация новых пользователей закрыта. Модуль работает для зарегистрированных ранее пользователей. Рекомендуем использовать модуль «Social Login»
...
2.  Пройдите на страницу API OAuth-авторизация: |link_yandex_oauth|
    ...
    .. |link_yandex_oauth| raw:: html
           ...
           <!--noindex--><a href="http://api.yandex.ru/oauth/" target="_blank" rel="nofollow">api.yandex.ru/oauth</a><!--/noindex-->
