...
Могу ли я самостоятельно поддерживать свой магазин в рабочем состоянии?
***********************************************************************

Вы можете :doc:`запустить свой интернет-магазин на CS-Cart </install/index>` и :doc:`работать с ним без посторонней помощи </user_guide/free_cscart_user>`. За нами — :doc:`исправление багов, добавление нового функционала </history/index>`. 

В случае возникновения трудностей с самостоятельной установкой, настройкой и поддержкой магазина на CS-Cart, обратитесь в `нашу техническую поддержку <https://www.cs-cart.ru/support-service.html>`_ или `воспользуйтесь услугами сторонних разработчиков <https://marketplace.cs-cart.com/developers-catalog.html>`_.
