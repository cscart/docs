...
.. important::
    ...
    Между CS-Cart 4.18.1 Beta и финальным релизом есть некоторые отличия. :ref:`Их список есть в конце статьи <comparing-beta-to-release>`.
...
=====================================================
Отличия между финальным релизом и CS-Cart 4.18.1 Beta
=====================================================
