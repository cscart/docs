...
1. Создайте новый способ доставки (:doc:`см. "Создание способа доставки" </manager/shippings/general/settings/index>`).
...
2. Выполните настройку нового способа доставки во вкладке “Настроить”.
    ...
    .. list-table::
        ...
        *   -   Тип доставки
            ...
            -   Службы доставки, которые покупатель сможет выбрать при оформлении заказа, а администратор — при редактировании заказа. Список доступных служб подгружается в CS-Cart из раздела **Настройки → Доставка** в учетной записи Яндекс.Доставки.
