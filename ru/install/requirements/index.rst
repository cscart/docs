...
* `PHP <http://www.php.net/>`_ версии 5.3.6, 5.4, 5.5, 5.6, или 7. CS-Cart поддерживает SAPI mod_php, FPM, FastCGI. Мы рекомендуем PHP 5.6 для CS-Cart 4.3.x. 

  .. note::

      Поддержка PHP 7.0 впервые появилась в CS-Cart 4.3.6. Для этой и последующих версий CS-Cart мы рекомендуем PHP 7.0.
...
* Установите и включите модуль PHP **Openssl**, чтобы генерировать более защищенные ключе сессий.
...
Требования, приведенные выше, довольно типичные. Многие хостинговые компании смогут предложить вам подходящий вариант. Если у вас возникли сложности с выбором, можете обратиться к нашему `списку совместимых хостингов (на английском языке) <http://www.cs-cart.com/compatible-hosting.html>`_.
