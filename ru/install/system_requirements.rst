...
Мы рекомендуем не переходить на PHP 5.6, если вы использовали PHP 7.0 и более новые версии для своего магазина. Это может привести к тому, что пользователи не смогут войти в систему.
