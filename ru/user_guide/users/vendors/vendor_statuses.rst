...
* **Новый** — администраторы продавца не могут работать в панели администратора, товары продавца не появятся на витрине. 
  ...
  Название статуса **Новый** нигде не отображается. Если владелец маркетплейса одобряет продавца, статус нового продавца автоматически меняется на **Вкл**. Если владелец решает отклонить продавца, статус продавца меняется на **Выкл**.

  .. note::

      Новые продавцы получат этот статус, если в разделе **Настройки → Общие → Продавцы** поставлена галочка **Проверка новых продавцов до предоставления доступа к панели администратора**.
...
* **Выкл.** — товары продавца не появляются в магазине, а администраторы продавца не могут войти в панель администратора.
  ...
  .. fancybox:: img/change_vendor_status-1.png
