...
#. Откройте страницу **Настройки → Поля профиля**.

#. Нажмите кнопку **+ Добавить поле** в правом верхнем углу, чтобы создать новое поле.
...
#. Нажмите кнопку **Сохранить**.
   ...
   .. fancybox:: img/docs_profile_fields-1.png
