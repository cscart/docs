...
* **Группы администраторов** определяют, что администраторы могут увидеть и сделать в панели администратора. Это полезно, если нужны учётные записи для персонала с ограниченными правами.
  ...
  .. hint::
      ...
      Управлять группами можно на странице **Пользователи → Группы пользователей**.

===============
Создание группы
===============

#. Откройте страницу **Пользователи → Группы пользователей** в панели администратора.

#. Нажмите кнопку **+ Добавить группу**. Откроется форма создания группы.
...
#. Нажмите кнопку **Создать**. Новая группа появится в списке.
...
#. Нажмите на кнопку **Запросы на добавление в группу**. Появится список запросов, ожидающих рассмотрения.

   .. fancybox:: img/manage_membership-1.png
...
#. Откройте страницу **Пользователи → Группы пользователей** и нажмите на название группы администраторов. 

#. Отметьте галочками привилегии, которые вы хотите назначить группе.

#. Нажмите кнопку **Сохранить**, чтобы применить изменения.

   .. fancybox:: img/admin_privileges-1.png
