...
.. note::
    ...
    Начиная с версии **CS-Cart 4.6.2**, для передачи данных о налогах в сервис "Яндекс.Касса" необходимо использовать :doc:`модуль "Налоговые ставки РФ" </user_guide/addons/rus_taxes/index>`.
