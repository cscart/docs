...
Если вы используете ЮKassa, то сможете автоматизировать пробитие чеков на онлайн-кассе, чтобы соответствовать требованиям закона 54-ФЗ. Есть два варианта:

* Подключить свою онлайн-кассу, которая поддерживается в личном кабинете ЮKassa. Именно этот вариант рассмотрен в статье, так как он потребует дополнительной настройки на стороне CS-Cart.

* Для новых клиентов ЮKassa также предлагает `встроенное решение для отправки чеков  <https://yookassa.ru/54fz/>`_. Комиссия за чек начинается от 0,1% (к вашей стандартной комиссии за каждый успешный платёж) и зависит от вашего оборота и платёжного способа, который выберет покупатель. Но в этом случае вы не платите за онлайн‑кассу и фискальный накопитель, не нужна регистрация в налоговой, подключение и настройка кассы.
...
#. Откройте страницу **Настройки → Способы оплаты** в панели администратора CS-Cart.
...
#. Откройте страницу **Настройки → Налоги** в панели администратора CS-Cart.
...
#. Включите этот налог в следующих местах:
   ...
   * **Настройки → Способы доставки** — на страницах редактирования всех способов доставки, которые облагаются этим налогом.
