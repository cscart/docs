...
1. Откройте страницу **Настройки → Тексты и языки** в панели администратора.

2. Нажмите кнопку **+ Добавить языковую переменную** и заполните поля:
...
6. Откройте страницу **Настройки → Способы оплаты**.
