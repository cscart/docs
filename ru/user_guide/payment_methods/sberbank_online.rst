...
3. Выберите процессор оплаты "Сбербанк Онлайн" в окне редактирования способа оплаты.

.. fancybox:: img/sberbank_online_select.png
    :alt: Sberbank

4. Пройдите во вкладку "Настроить" нового способа оплаты и выполните настройку.

.. fancybox:: img/sberbank_online_settings.png
