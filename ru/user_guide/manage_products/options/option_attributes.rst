...
* **Название** — название глобальной опции, которое появится только в панели администратора и поможет отличить несколько опций с одинаковым названием.

* **Название на витрине** — название опции товара, которое отобразится на витрине.
...
* **Продавец** (есть только в Multi-Vendor) — продавец, к чьим товарам будет применена опция.
