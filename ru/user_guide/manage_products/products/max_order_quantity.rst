...
#. Введите нужное количество экземпляров товара в поле **Максимальное количество для покупки одного товара** из раздела **Ценообразование/Склад**.
...
#. Нажмите кнопку **Сохранить**.
   ...
   .. important::
       ...
       После этого покупатель не сможет за один заказ приобрести больше экземпляров товара, чем указано в поле **Максимальное количество для покупки одного товара**.
