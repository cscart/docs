...
.. list-table::
    ...
    *   -   Отображение на витрине
        ...
        -   Покупатели могут выбрать нужную вариацию на странице товара, выбрав вариант у каждой опции. Но администратор может :doc:`создать блок со всеми вариациями товара на странице этого товара </user_guide/look_and_feel/layouts/blocks/variations>`. Так покупатели могут на странице товара увидеть все доступные вариации и их количество на складе, а также добавить разные вариации в корзину без необходимости вручную выбирать другие варианты у опций.
