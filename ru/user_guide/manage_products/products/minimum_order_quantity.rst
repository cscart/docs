...
#. Введите нужное количество экземпляров товара в поле **Минимальное количество для покупки одного товара** из раздела **Ценообразование/Склад**.

   .. fancybox:: img/min_quantity.png
       :alt: Задаём минимальное количество экземпляров товара в заказе в CS-Cart.
