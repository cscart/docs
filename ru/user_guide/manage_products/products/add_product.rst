...
#. Откройте в панели администратора магазина страницу **Товары → Товары** и нажмите кнопку **+ Добавить товар** в правой верхней части страницы.
...
#. Нажмите кнопку **Добавить несколько товаров**.

   .. fancybox:: img/catalog_31.png
       :alt: Нажмите "Добавить несколько товаров".
...
#. Нажмите на кнопку **Ещё** в правой верхней части страницы и выберите **Обновить все**.
...
У товаров, которые имеют файлы для скачивания, будет доступная новая вкладка "Прикрепленные файлы".
