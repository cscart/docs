...
#. Откроется страница создания товара. Задайте несколько свойств, обязательных для каждого товара. Вы сможете изменить свойства товара в любой момент. Единственное, с чему нужно определиться сейчас — создаёте ли вы :doc:`простой или настраиваемый товар </user_guide/manage_products/products/simple_versus_configurable>`.
