...
#. Нажмите кнопку **Сохранить** в правой верхней части страницы.
   ...
   Можно сделать **Сортировать по позиции: низкие позиции выше** или **Сортировать по позиции: высокие позиции ниже** способом сортировки по умолчанию. Для этого на странице **Настройки → Общие → Внешний вид** выберите этот способ сортировки в выпадающем списке **Сортировка списка товаров по умолчанию**. Перед этим убедитесь, что для этого способа сортировки стоит галочка в настройке **Доступные способы сортировки списка товаров**. 
