...
#. Нажмите кнопку **+ Добавить промо-акцию** в правом верхнем углу и выберите вариант **Добавить промо-акцию для корзины**.
...
#. Убедитесь, что фраза над списком условий звучит так: *Если каждое из этих условий выполняется*.
   ...
   .. fancybox:: img/two_products-1.png
...
#. Нажмите кнопку **Создать**.
   ...
   .. fancybox:: img/two_products-2.png
