...
.. list-table::
        ...
        *   -   Стало
            ...
            -   Вы можете задать максимальный долг не только глобально, но и индивидуально — в настройках :doc:`тарифных планов <user_guide/addons/vendor_plans/>`. 
...
Если модуль был у вас выключен или не установлен, то при обновлении он установится самостоятельно. В настройках модуля вы можете указать значения минимально допустимого баланса и льготного периода. Они будут одинаковыми для всех продавцов. Таким образом, новый модуль по работе с должниками будет повторять поведение старого модуля.