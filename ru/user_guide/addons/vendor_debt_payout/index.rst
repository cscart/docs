...
Модуль позволяет выбрать минимально разрешённый баланс для продавцов, а также срок пополнения баланса. Если баланс опустится ниже разрешённого, а продавец не пополнит его в срок, то он получит статус "Приостановлен" со всеми сопутствующими ограничениями. Помимо глобальной настройки (в настройках модуля), когда владелец маркетплейса устанавливает одинаковые условия для всех, он может установить разные условия для разных продавцов.
