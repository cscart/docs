...
Помимо глобальной настройки (в настройках модуля), когда владелец маркетплейса устанавливает одинаковые условия для всех должников, он может установить разные условия для разных продавцов.
