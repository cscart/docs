...
Решайте, когда считать продавцов должниками
+++++++++++++++++++++++++++++++++++++++++++

Модуль позволяет выбрать минимально разрешённый баланс для продавцов, а также срок пополнения баланса. Если баланс опустится ниже разрешённого, а продавец не пополнит его в срок, то он получит статус "Приостановлен" со всеми сопутствующими ограничениями.

.. fancybox:: img/global_settings-1.png
    :alt: Глобальные настройки в настройках модуля

По умолчанию, минимально разрешённый баланс и срок на его пополнение задаются в настройках модуля. Но вы можете разрешить свои значения для отдельных :doc:`тарифных планов </user_guide/addons/vendor_plans/index>`.

.. fancybox:: img/plan_settings-1.png
...
Такие меры позволяют дополнительно стимулировать продавцов погасить их задолженность.


Предоставьте продавцам возможность легко оплатить долг
++++++++++++++++++++++++++++++++++++++++++++++++++++++

Благодаря модулю, продавцы могут погасить задолженность в любой момент без каких-либо сложностей. Достаточно выбрать сумму пополнения и нажать кнопку "Пополнить баланс", после чего продавец будет перенаправлен на страницу оплаты. Все блокировки автоматически снимутся после того, как оплата будет обработана.

.. fancybox:: img/admin_panel_blocked-1.png
    :alt: Сообщение о заблокированной панели администратора и кнопка погашения задолженности


Предупреждайте продавцов о долге и отслеживайте должников
+++++++++++++++++++++++++++++++++++++++++++++++++++++++++
...
Ссылки на настройки уведомлений доступны в настройках модуля. Также настройки доступны на странице **Настройки** → **Уведомления**.

Раз в неделю владелец маркетплейса получает сводку о состоянии долгов и учетных записей должников.


Находите неактивных продавцов
+++++++++++++++++++++++++++++
