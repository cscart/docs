...
.. note::
    ...
    Для корректной работы сервиса "АТОЛ Онлайн" необходимо настроить существующие налоги с помощью модуля :doc:`/user_guide/addons/rus_taxes/index`.
...
После того, как вы выполнили все предыдущие шаги, настройка магазина закончена, а модуль готов к работе.
