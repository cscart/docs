...
* **Комбинация из одной опции (цена в модификаторах)** — все характеристики товара в 1С будут объединены на стороне CS-Cart в одну опцию с несколькими вариантами вида *"Размер: 12, Цвет: Белый"*. 
  ...
  Цена самого товара будет равна нулю, но у каждого варианта опции на стороне CS-Cart будет своя цена. Она будет указана через модификатор цены это варианта.
...
#. После записи данная номенклатура появиться в списке номенклатур. Выберите созданную номенклатуру и нажмите на кнопку редактировать.
