...
.. important::
    ...
    Характеристикам номенклатуры (т.е. торговым предложениям) из 1С в CS-Cart соответствуют :doc:`вариации товаров </user_guide/manage_products/products/product_variations>`. Поэтому должен быть включен модуль :doc:`"Вариации товаров" </user_guide/addons/product_variations/index>`. Выгрузка работает только со схемой версии 2.05.
