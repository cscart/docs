...
11. Пройдите на страницу создания провайдеров в панели администратора интернет-магазина. 
    ...
    Создайте нового провайдера с сервисом «Facebook», используя ключи из приложения Facebook. Затем скопируйте ссылку из поля «Valid OAuth redirect URIs» в такое же поле в приложении в Facebook.
