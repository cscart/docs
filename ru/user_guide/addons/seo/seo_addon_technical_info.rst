...
SEO имя должно быть уникально в пределах полного URI. Т.е. могут быть 2 продукта с одним и тем же SEO-именем в разных категориях (men/shoes, women/shoes). Если при добавлении и редактировании имени для объекта заданное имя уже будет существовать, к имени автоматически добавится индекс.
