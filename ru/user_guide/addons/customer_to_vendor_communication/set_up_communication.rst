...
#. Установите модуль :doc:`/user_guide/addons/customer_to_vendor_communication` так же, :doc:`как и любой другой модуль </user_guide/addons/1manage_addons>`.
   ...
   * **Для покупателей**:
     ...
     * **Отображать кнопку чата на странице микромагазина продавца** — если включить эту настройку, то кнопка “Задать вопрос” появится на странице микромагазина продавца.
     ...
     .. important::
	     ...
	     Эта настройка влияет только на продавцов, у которых микромагазин включен в :doc:`тарифном плане </users/vendors/manage_vendor_plans.html>`.
		 
Как ограничить общение продавцов с покупателями и администратором?
==================================================================

Использование модуля "Центр сообщений" в сочетании с модулем :doc:`/user_guide/addons/vendor_privileges` позволяет владельцу маркетплейса решить, кому, как и с кем общаться.
