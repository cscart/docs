...
.. list-table::
    ...
    *   -   Авторизация
        ...
        -   Если настройка включена, то достпу к прайс-листу бдет доступен только по ключу доступа

    *   -   Ключ доступа

        -   Ключ для доступа к прайс-листу при включеной настройке авторизации

    *   -   Имя прайс-листа

        -   Имя которое будет отображаться в спике прайс-листов
...
.. list-table::
    ...
    *   -   Габаритные размеры
        ...
        -   Выгружать габариты. Размеры товара будут склеины из параметров "Длина коробки", "Ширина коробки" и Высота коробки,
            которые указыватьюся во вкладке "Параметры доставки"
