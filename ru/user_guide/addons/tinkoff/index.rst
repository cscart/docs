...
Владелец магазина или маркетплейса заключает договор с банком и подключает онлайн кассу. Продавцам остаётся только :ref:`заполнить форму регистрации прямо из своей панели <vendor-registration>`, а подключать кассу не нужно.
