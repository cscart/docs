...
1. Откройте `Events Manager <https://facebook.com/events_manager2>`_.

2. Нажмите |plus_button|, **Подключить источники данных** и выберите **Интернет**.
...
.. fancybox:: img/overview.png
    :alt: Вкладка Обзор в Events Manager.
...
.. fancybox:: img/testing.png
    :alt: Вкладка Тестирование в Events Manager.
