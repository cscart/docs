...
#. В панели администратора перейдите на **Веб-сайт → Страницы**. В правом верхнем углу нажмите **+ добавить страницу** и выберите пункт **Добавить страницу из Тильды**.
...
#. В панели администратора перейдите на **Веб-сайт → Темы → Макеты**.
