...
У CS-Cart для маркетплейсов адаптивный дизайн. Это значит, что магазин подстраивается под размеры экрана тех устройств, с которых его просматривают. Так покупатели могут оставлять заказы со смартфонов или планшетов.
...
* **Приложение — это один из видов рекламы.** Во-первых, логотип магазина (или любое другое изображение на ваш выбор) появится в Apple App Store и в Google Play как иконка приложения. Во-вторых, если покупатель скачает приложение, то эту иконку он будет регулярно видеть на экране смартфона среди других приложений.
  ...
  .. fancybox:: img/responsive_vs_mobile.png
      :alt: Мобильное приложение в сравнении с адаптивным сайтом на CS-Cart для маркетплейсов.
...
.. warning::   
    Мобильное приложение поддерживает модуль :doc:`/user_guide/addons/direct_customer_to_vendor_payments/index` из CS-Cart для маркетплейсов Plus и Ultimate, начиная с версии CS-Cart для маркетплейсов 4.12.3.
...
Тексты мобильного приложения находятся в CS-Cart для маркетплейсов в модуле **Мобильное приложение**. Когда появится поддержка других языков, то переводы на них будут выполняться сообществом и проверяться нашими партнёрами `в проекте на сервисе CrowdIn <https://crowdin.com/project/cs-cart-latest>`_.

.. fancybox:: img/crowdin_project.png
    :alt: Проект по переводу CS-Cart для маркетплейсов на сервисе CrowdIn.
...
Да, но это зависит от редакции CS-Cart для маркетплейсов edition. Подробности есть `на странице сравнения редакций CS-Cart для маркетплейсов <https://multivendor.cs-cart.ru/#compare>`_.
...
Если у вас не последняя версия, просто упомяните это при обращении к нам, и мы поможем начать. Например, модуль **Мобильное приложение** впервые появился в версии 4.8.1, но с тех пор мы его улучшили. Поэтому нам может сначала потребоваться перенести эти улучшения на вашу установку CS-Cart для маркетплейсов.
...
Тексты приложения являются частью модуля **Мобильное приложение**, и их можно редактировать в панели администратора магазина. Редактирование текстов работает так же, как :doc:`перевод CS-Cart для маркетплейсов </user_guide/look_and_feel/languages/translate>`:

#. Откройте страницу **Администрирование → Тексты и языки → Редактировать тексты**. 
...
#. Отредактируйте переводы. После сохранения ваши изменения автоматически появятся в магазине.
   ...
   .. fancybox:: img/mobile_app_texts.png
       :alt: Переводы мобильного приложения в панели администратора CS-Cart для маркетплейсов.
...
.. fancybox:: img/mobile_app_banners.png
    :alt: Устанавливаем для баннера URL, который будет работать и в CS-Cart для маркетплейсов, и в мобильном приложении.
...
* Выберите любую другую оболочку, если хотите, чтобы заголовок отображался.
  ...
  .. fancybox:: img/wrappers.png
      :alt: Оболочка блока в CS-Cart для маркетплейсов определяет, появится ли заголовок у блока на домашней странице в мобильном приложении.
...
#. Откроются настройки блока. Перейдите на вкладку **Контент**. Здесь вы сможете выбрать страницы, которые должны появиться в боковой панели мобильного приложения.
   ...
   .. fancybox:: img/sidebar_menu.png
       :alt: Элементы меню в CS-Cart для маркетплейсов и в мобильном приложении.
