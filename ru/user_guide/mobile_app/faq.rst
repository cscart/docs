...
#. Если вы решите, что вам нужно приложение (или если возникнут какие-то вопросы), свяжитесь с нами через форму `обратной связи <https://www.cs-cart.ru/contacts>`_.
...
Изменять домашнюю страницу и меню "Страницы" в настройках профиля нужно в панели администратора маркетплейса. Откройте страницу **Веб-сайт → Темы →  Макеты** и переключитесь на макет **MobileAppLayout**. Он появится только при установленном модуле **Мобильное приложение**.
...
Откройте страницу **Веб-сайт → Темы → Макеты** и выберите макет **MobileAppLayout**. Перейдите на вкладку **Homepage** и нажмите на иконку шестерёнки у нужного блока, чтобы открыть его настройки. Так вы сможете выбрать оболочку для блока:
...
#. Откройте страницу **Веб-сайт → Темы → Макеты**.
