...
<<<<<<< HEAD
Да, но не в рамках стандартных планов. Подробности читайте в разделе с ценами на страницах приложения `для Multi-Vendor <https://www.cs-cart.com/multivendor-mobile-application.html>`_.
=======
...
>>>>>>> 69e236b6... En&Ru: Mobile App FAQ: Link adjusted.
