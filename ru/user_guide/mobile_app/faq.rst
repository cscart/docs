...
.. note::
    `Google Firebase объявил <https://firebase.google.com/docs/cloud-messaging/send-message#send_using_the_fcm_legacy_http_api>`_, что возможность отправлять push-сообщения с использованием старой интеграции будет удалена в **июне 2024 года**. Чтобы push-уведомления продолжали работать, мы обновили Мобильное приложение в версии 4.18.1 SP1. В этом обновлении используется новая интеграция Firebase HTTP v1.
    
    Что нужно сделать:

    * **Обновите CS-Cart до версии 4.18.1 SP1**: Установите эту или более новую версию, чтобы продолжить отправлять push-сообщения.
    * **Настройте Firebase**: После обновления вы получите уведомление с краткими инструкциями по настройке Firebase.
