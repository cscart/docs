...
В меню **Покупатели** можно создавать, просматривать, редактировать и удалять *учетные записи пользователей*.

**Учетные записи** хранятся в базе данных магазина и содержат информацию о конкретных пользователях. К учетным записям привязывается информация о заказах, подписках и т.д. 
...
* **Покупатели** — могут войти в учетную запись на витрине магазина и могут покупать товары. Обычно для просмотра и покупки товаров на витрине не требуется учетная запись. У зарегистрированных пользователей больше возможностей, а еще их можно разбить по группам.
...
Если приходится часто искать определенных пользователей (например, только из какой-то конкретной страны), рекомендуем сохранить поиск. Тогда он будет появляться справа от списка пользователей.
...
.. image:: img/users_actions.png
    :align: center
    :alt: Список возможных действий над учетной записью.
