...
.. important::
    ...
    Эти поля не появятся, если на странице **Модули → Скачанные модули** не включены модули **"Социальные кнопки"**, **"Отзывы и комментарии"** и **"SEO"**.
...
.. note::
    ...
    Вкладка не появится, если на странице **Модули → Скачанные модули** не включен модуль **"Теги"**.
