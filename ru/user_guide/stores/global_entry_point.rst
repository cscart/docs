...
.. important::
    ...
    Статья актуальна только для пользователей CS-Cart Ultimate. В Multi-Vendor Ultimate вы можете :doc:`автоматически перенаправить покупателей из определённых регионов на соответствующие витрины <redirect_regional_customers_to_storefront>`.
