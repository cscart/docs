...
Перейдя на страницу **Настройки → Хранилище данных**, вы найдете **Менеджер файлов**, с помощью которого можно напрямую через панель администратора работать с различными файлами.
