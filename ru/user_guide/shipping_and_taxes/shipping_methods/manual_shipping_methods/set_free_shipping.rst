...
#. Настройте секцию **Зависимость от цены** следующим образом:
   ...
   .. important::
       ...
       Данный способ доставки будет бесплатным только для выбранной тарифной зоны и если в секциях **Зависимость от веса** и **Зависимость от количества** не указаны соответствующие тарифы.
