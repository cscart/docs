...
3.  Выполните настройку нового способа доставки во вкладке "Настроить".
    ...
    .. note::
        ...
        После регистрации на сайте |link2| сервисом предоставляются отдельные логин и пароль для отслеживания посылки через API. Доступные настройки способа доставки зависят от выбранного вида отправления.
