...
Хотя не все проблемы можно решить на стороне магазина, узнавать о них нужно. Поэтому в CS-Cart 4.8.1 (и более новых версиях) появилась отправка email-уведомлений администраторам о подобных проблемах. Чтобы получать эти уведомления на электронную почну:
