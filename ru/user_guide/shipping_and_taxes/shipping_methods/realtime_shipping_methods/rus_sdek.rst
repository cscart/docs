...
#. Установите модуль ":doc:`СДЭК </user_guide/addons/rus_sdek/index>`".
   ...
   * На вкладке **Настроить**:
     ...
     * **Пароль для доступа к серверу расчетов**
       ...
       .. important::
           ...
           Ключи интеграции (логин и пароль) находятся в личном кабинете СДЭК в разделе `"Интеграция" <https://lk.cdek.ru/user/login>`_.
