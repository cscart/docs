...
.. hint::
    ...
    Если вы хотите сделать способ доставки с ручным расчётом тарифа бесплатным, то вам всё равно нужно будет добавить хотя бы одну сумму для нужного пункта назначения. Задать стоимость можно так, как указано в примере ниже:
