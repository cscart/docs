...
#. Откройте страницу **Настройки → Статусы → Статусы заказов** в панели администратора магазина.

#. Выберите, хотите ли вы:

   * создать новый статус (для этого нажмите кнопку **+ Добавить статус**);

   * отредактировать существующий статус (для этого нажмите на его название);

   * отсортировать статусы с помощью перетаскивания.

   .. fancybox:: img/order_status-2.png
...
.. important::
    ...
    Свойства, описанные ниже, появятся только, если на странице **Модули → Скачанные модули** включены соответствующие модули: **Поставщики**, **Подарочные сертификаты**, **Возврат товаров**, **Бонусные баллы**.
...
.. fancybox:: img/order_status-1.png
