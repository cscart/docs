...
#. Откройте страницу **Заказы → Заказы** в панели администратора магазина.
...
#. Если вы внесли изменения на этой странице, нажмите **Сохранить**.

   .. fancybox:: img/order_details_page-1.png
...
#. Выберите действие **Редактировать заказ**, чтобы открыть страницу редактирования.
   ...
   .. fancybox:: img/order_editing_page-1.png
