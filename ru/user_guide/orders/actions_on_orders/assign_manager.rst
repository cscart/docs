...
.. fancybox:: img/manager_on_the_list-1.png
...
#. Откройте страницу **Заказы → Заказы**.

#. Нажмите на ID нужного заказа.

#. Найдите справа поле **Менеджер** и нажмите на кнопку **Выбрать**.

   .. fancybox:: img/add_manager-1.png
       :alt: Нажмите кнопку рядом с полем "Менеджер", чтобы назначить заказу менеджера.
...
#. Нажмите кнопку **Сохранить**.
   ...
   .. fancybox:: img/select_manager-1.png
       :alt: Выберите нужного администратора, а затем нажмите кнопку "Выбрать".

   .. note::

       После того, как менеджер выбран, его нельзя удалить из заказа. Однако вы можете нажать на кнопку рядом с полем "Менеджер" еще раз, чтобы заменить выбранного менеджера на другого.
