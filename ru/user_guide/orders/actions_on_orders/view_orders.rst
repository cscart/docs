...
На странице **Заказы → Заказы** выводится список всех заказов в магазине, которые были сделаны и не были удалены. По умолчанию, заказы отсортированы по дате: чем новее заказ, тем он выше в списке.
...
.. fancybox:: img/view_orders-1.png
    :alt: На странице "Заказы → Заказы" можно увидеть список всех заказов.
