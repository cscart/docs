...
Вы можете управлять языками доступными в вашем магазине из **Администрирование → Тексты и языки → Языки**. На данной странице представлены две вкладки:
...
1. В панели администратора откройте **Администрирование → Тексты и языки → Языки**.
