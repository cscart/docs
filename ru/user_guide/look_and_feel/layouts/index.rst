...
Каждый блок отображает какую-то информацию: логотип, информацию о товаре, строку навигации, поисковую форму и т.п. Перетаскивая, редактируя и удаляя блоки, вы меняете структуру страницы.
