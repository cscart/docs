...
Загрузить новую тему можно с помощью копки **+** в правом верхнем углу страницы. В открывшемся выберите способ загрузки файла: с компьютера (**Загрузить**), с сервера, на котором установлен CS-Cart (**Сервер**) или по ссылке с удаленного сервера (**URL**). Когда выберите вариант, нажмите кнопку **Загрузить**.
