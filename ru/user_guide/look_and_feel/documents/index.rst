...
CS-Cart и Multi-Vendor встроен редактор документов (счетов, упаковочных листов и подарочных сертификатов). Редактор позволяет изменять документы в соответствии с вашими нуждами, экспортировать их, а также импортировать документы, созданные и экспортированные другими людьми.

Для доступа к редактору шаблонов перейдите в меню **Дизайн → Документы**.

.. note::

    Если вы не видите этот пункт меню, то сначала вам возможно понадобится :doc:`включить редактор самостоятельно <enable_document_editor>`.
...
Вы также увидите список почтовых уведомлений, в которве включен этот документ. Список появится под списками переменных и сниппетов, если документ включен хотя бы в один из шаблонов email-уведомлений.
