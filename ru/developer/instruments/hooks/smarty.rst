...
Практически все шаблоны темы CS-Cart (Multi-Vendor) содержат хуки. 

Вы можете подключись свой шаблон перед хуком, после хука или заменить полностью код внутри хука.
