...
Папка **migrations** содержит phinx-:doc:`миграции <upgrade_addon>`. Применяются в порядке *TIMESTAMP* имени файла. Теоретически, миграции должны работать только с БД. На практике они работают в окружении CS-Cart и могут делать что угодно. 
