...
2.   In the currently used theme click the **Visual Editor** button.
...
.. important ::
	...
	Default styles can not be changed. Create a new style to upload your favicon. To do it, choose one of the default styles, click the **Save** button near it, and type a new style name in the pop-up window.
