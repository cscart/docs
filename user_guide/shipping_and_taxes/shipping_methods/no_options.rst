...
*   If you set up a manual shipping method follow `this article <http://kb.cs-cart.com/manual-ship-method>`_.
*   If you set up a realtime shipping method follow `this <http://kb.cs-cart.com/real-shipping-method>`_ article.
*   If the **Suppliers** functionality is enabled in your CS-Cart, check whether it is set up properly by using the instructions `here <http://kb.cs-cart.com/suppliers-functionality>`_.
