...
If the content you entered in the `WYSIWYG <https://en.wikipedia.org/wiki/WYSIWYG>`_ editor is not desplayed properly on the storefront, make sure that the HTML content is not copied and pasted from another text editor (e.g. **Microsoft Word**). 
