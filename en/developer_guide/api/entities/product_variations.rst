...
To see how the ``product_variations`` entity worked in older versions, `check the documentation for 4.9.x <https://docs.cs-cart.com/4.10.x/developer_guide/api/entities/product_variations.html>`_.
