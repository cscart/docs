...
extensions = ['edit_on_github', 'canonical_latest', 'sphinx_sitemap']
...
# of the sidebar.
html_logo = '_static/cscart_logo.svg'
...
# the title page.
latex_logo = '_static/cscart_logo.svg'
...
epub_copyright = '2015, Konstantin Molchanov'
