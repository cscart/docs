...
#. Fill in the form.
   ...
   * **Type**—the type of users that will be a part of the group (:doc:`customers </user_guide/users/customers/index>` and :doc:`administrators </user_guide/users/administrators/index>`).
