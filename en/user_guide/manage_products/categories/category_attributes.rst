...
This tab duplicates the :doc:`global layout </user_guide/look_and_feel/layouts/index>` of the category page from **Website → Themes → Layouts** section of the Administration panel.
