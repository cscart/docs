...
*	**Awaiting call** - Order was created and customer sent a call request. This status is associated with the `Call requests <http://docs.cs-cart.com/4.4.x/user_guide/addons/call_requests/index.html>`_ add-on.
