...
The **Settings → Statuses → Order statuses** page allows you to adjust the default set of order statuses. You can easily sort statuses according to your business needs, edit the details of the existing statuses as well as add custom statuses.
