...
* If the **index.tpl** file exists in this directory, check the `permissions <http://docs.cs-cart.com/4.3.x/install/useful_info/permissions.html>`_ for this file. The file should have the **644** permissions; if it doesn't, change the permissions accordingly.
