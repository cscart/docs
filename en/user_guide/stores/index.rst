...
`CS-Cart Ultimate <https://helpdesk.cs-cart.com/cs-cart-ultimate-license.html>`_ and `Multi-Vendor Ultimate <https://helpdesk.cs-cart.com/multi-vendor-ultimate-on-premises.html>`_ allow you to manage multiple storefronts with one administration panel. Storefronts behave slightly differently:
