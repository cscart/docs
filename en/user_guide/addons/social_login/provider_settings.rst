...
* **Valid OAuth redirect URIs**—the value of this field is generated by CS-Cart and needs to be copied to the same field of an application at `Facebook.com <https://developers.facebook.com/apps>`_.
