...
.. note::
    ...
    This add-on requires the :doc:`/user_guide/addons/data_feeds/index` add-on.
...
.. meta::
   :description: An add-on for exporting product data from CS-Cart online store or Multi-Vendor marketplace to Google Merchant Center.
