...
=============
    ...
    The add-on is compatible with CS-Cart 4.3.5 and above, but only versions 4.11.x, 4.12.x and 4.13.x are supported. The minimum PHP version should be at least 5.4.0. PHP extensions ``xmlwriter``, ``openssl``, ``dom``, ``hash`` are required.
