...
=============
    ...
    The add-on is compatible with CS-Cart and Multi-Vendor 4.4 and above, but only versions 4.11.x, 4.12.x and 4.13.x are supported. Need compatibility with another CS-Cart version? Contact us now.
...
====================
    ...
    If you fail validation, you will see errors alongside the HTML source of the page. In this case, contact us for help via our `help desk system <http://www.simtechdev.com/helpdesk>`_.
