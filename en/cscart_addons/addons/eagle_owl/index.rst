...
=============
    ...
    The add-on is compatible with CS-Cart, CS-Cart Ultimate, Multi-Vendor and Multi-Vendor Ultimate 4.10 and above, but only versions 4.11.x, 4.12.x and 4.13.x are supported. PHP 7.0 and higher is required. 
