...
=============
    ...
    The Urban Shift Theme is compatible with CS-Cart and Multi-Vendor 4.3 and above, but only versions 4.11.x, 4.12.x and 4.13.x are supported.

    Theme is compatible with RTL languages.
