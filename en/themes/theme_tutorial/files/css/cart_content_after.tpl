...
<head>
  ...
  / source  / developer / themes / top_panel_header / files / css / cart_content_after.tpl
 &mdash; Bitbucket
</title>
...
<ul role="menu" class="aui-nav">
  ...
  <li>
    ...
    <li id="user-options">
          ...
          <a href="/account/signin/?next=/cs-cart/docs.cs-cart.ru/src/4967dd072e7182621ce79f60cde9e56a2637eff2/developer/themes/top_panel_header/files/css/cart_content_after.tpl%3Fat%3D4.1.x" class="aui-nav-link login-link">Log in</a>
...
<div class="sourcetree-callout clone-in-sourcetree"
  ...
  <div class="secondary-actions">
    <div class="aui-buttons">
        ...
        <a href="/cs-cart/docs.cs-cart.ru/src/4967dd072e71/developer/themes/top_panel_header/files/css/cart_content_after.tpl?at=4.1.x"
           class="aui-button aui-style pjax-trigger" aria-pressed="true">
          Source
        </a>
        <a href="/cs-cart/docs.cs-cart.ru/diff/developer/themes/top_panel_header/files/css/cart_content_after.tpl?diff2=4967dd072e71&at=4.1.x"
           class="aui-button aui-style pjax-trigger"
           title="Diff to previous change">
          Diff
        </a>
        <a href="/cs-cart/docs.cs-cart.ru/history-node/4967dd072e71/developer/themes/top_panel_header/files/css/cart_content_after.tpl?at=4.1.x"
           class="aui-button aui-style pjax-trigger">
          History
        </a>
  ...
  <h1>
        ...
        <a href="/cs-cart/docs.cs-cart.ru/src/4967dd072e71?at=4.1.x"
          class="pjax-trigger root" title="cs-cart/docs.cs-cart.ru at 4967dd072e71">docs.cs-cart.ru</a> /
              ...
              <span class="file-name">cart_content_after.tpl</span>
  ...
  <div class="clearfix"></div>
    ...
    <div id="editor-container" class="maskable"
         ...
         data-branch="4.1.x"
         data-path="developer/themes/top_panel_header/files/css/cart_content_after.tpl"
         data-source-url="/api/1.0/repositories/cs-cart/docs.cs-cart.ru/src/4967dd072e7182621ce79f60cde9e56a2637eff2/developer/themes/top_panel_header/files/css/cart_content_after.tpl">
  ...
  <span class="aui-icon-dropdown"></span>
          ...
          <a href="/cs-cart/docs.cs-cart.ru/full-commit/4967dd072e71/developer/themes/top_panel_header/files/css/cart_content_after.tpl" id="full-commit-link"
              title="View full commit 4967dd0">Full commit</a>
          </div>
            <div class="secondary">
              <div class="aui-buttons">
                
                  <a href="/cs-cart/docs.cs-cart.ru/annotate/4967dd072e7182621ce79f60cde9e56a2637eff2/developer/themes/top_panel_header/files/css/cart_content_after.tpl?at=4.1.x"
                  class="aui-button aui-style pjax-trigger">Blame</a>
                
                
                  
                  <a id="embed-link" href="https://bitbucket.org/cs-cart/docs.cs-cart.ru/src/4967dd072e7182621ce79f60cde9e56a2637eff2/developer/themes/top_panel_header/files/css/cart_content_after.tpl?embed=t"
                    class="aui-button aui-style" data-modules="repo/source/embed">Embed</a>
                
                <a href="/cs-cart/docs.cs-cart.ru/raw/4967dd072e7182621ce79f60cde9e56a2637eff2/developer/themes/top_panel_header/files/css/cart_content_after.tpl"
...
<a href="#cl-10">10</a>
<a href="#cl-11">11</a>
<a href="#cl-12">12</a></pre></div></td><td class="code"><div class="highlight"><pre><a name="cl-1"></a> <span class="nt">&lt;div</span> <span class="na">id=</span><span class="s">&quot;sw_dropdown_</span><span class="cp">{</span><span class="nv">$dropdown_id</span><span class="cp">}</span><span class="s">&quot;</span> <span class="na">class=</span><span class="s">&quot;ty-dropdown-box__title cm-combination&quot;</span><span class="nt">&gt;</span>
...
<a name="cl-5"></a>                <span class="nt">&lt;span</span> <span class="na">class=</span><span class="s">&quot;ty-minicart-title&quot;</span><span class="nt">&gt;&lt;i</span> <span class="na">class=</span><span class="s">&quot;tt-icon-bag&quot;</span><span class="nt">&gt;&lt;/i&gt;&lt;span</span> <span class="na">class=</span><span class="s">&quot;ty-minicart-title__amount&quot;</span><span class="nt">&gt;</span><span class="cp">{</span><span class="nv">$smarty.session.cart.amount</span><span class="cp">}</span><span class="nt">&lt;/span&gt;&lt;/span&gt;</span>
<a name="cl-6"></a>                <span class="nt">&lt;span</span> <span class="na">class=</span><span class="s">&quot;ty-minicart-title__price&quot;</span><span class="nt">&gt;</span><span class="cp">{</span><span class="nf">include</span> <span class="na">file</span><span class="o">=</span><span class="s2">&quot;common/price.tpl&quot;</span> <span class="na">value</span><span class="o">=</span><span class="nv">$smarty.session.cart.display_subtotal</span><span class="cp">}</span><span class="nt">&lt;/span&gt;</span>
<a name="cl-7"></a>            <span class="cp">{</span><span class="nf">else</span><span class="cp">}</span>
<a name="cl-8"></a>                <span class="nt">&lt;span</span> <span class="na">class=</span><span class="s">&quot;ty-minicart-title empty-cart&quot;</span><span class="nt">&gt;&lt;i</span> <span class="na">class=</span><span class="s">&quot;tt-icon-bag&quot;</span><span class="nt">&gt;&lt;/i&gt;&lt;/span&gt;</span>
<a name="cl-9"></a>            <span class="cp">{</span><span class="nf">/if</span><span class="cp">}</span>
<a name="cl-10"></a>        <span class="cp">{</span><span class="nf">/hook</span><span class="cp">}</span>
<a name="cl-11"></a>    <span class="nt">&lt;/a&gt;</span>
<a name="cl-12"></a><span class="nt">&lt;/div&gt;</span>
</pre></div>
</td></tr></table>
  </div>
    ...
    <div class="tab-pane active-pane" id="branches" data-filter-placeholder="Filter branches">
      <ol class="filter-list">
        ...
        [[#branches]]
            ...
            [[#hasMultipleHeads]]
              [[#heads]]
                <li class="comprev filter-item">
                  <a class="pjax-trigger" href="/cs-cart/docs.cs-cart.ru/src/[[changeset]]/developer/themes/top_panel_header/files/css/cart_content_after.tpl?at=[[safeName]]"
                     title="[[name]]">
                    [[name]] ([[shortChangeset]])
                  </a>
                </li>
            ...
            [[^hasMultipleHeads]]
              <li class="comprev filter-item">
                <a class="pjax-trigger" href="/cs-cart/docs.cs-cart.ru/src/[[changeset]]/developer/themes/top_panel_header/files/css/cart_content_after.tpl?at=[[safeName]]" title="[[name]]">
                  [[name]]
                </a>
              </li>
            [[/hasMultipleHeads]]
