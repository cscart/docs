...
[*] Mobile application: Missing translations were added.
...
[!] Add-ons: Newsletters: If a user tried to subscribe to the store, which has no mailing list, the subscription was not created. Fixed.
...
[!] Design: Vendors: Stripe Connect: The vendor list was not displayed correctly with vendors connected to Stripe Connect. Fixed.
