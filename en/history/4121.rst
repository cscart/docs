...
[+] Rate areas: A сontext menu was added to еthe list of rat areas.
...
[!] Add-ons: Email marketing: An SQL error occurred when the add-on was installed again after deletion. Fixed.
...
[!] Block manager: Lite checkout: The selected wrapper 'lite checkout' was not saving in the grid's properties. Fixed.
...
[!] Checkout: If you used whitespace characters for the required fields, then you could place an order. Fixed. 
...
[!] Design: There were some minor design issues in the customer are on mobile devices. Fixed.
...
[!] Multi-Vendor: Add-ons: Vendor locations: Vendor couldn't remove his location in the settings. Fixed.
