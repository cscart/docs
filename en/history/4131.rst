...
[!] Add-ons: Newsletters: Available mailings weren't displayed on the page with subscribers. Fixed.

[!] Multi-Vendor: Add-ons: Vendor Privileges: Messages from the marketplace administrator weren't displayed in the vendor panel if the "Message center: communication with customer" order privilege was disabled. Fixed.