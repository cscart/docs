...
=============
    ...
    Minimum required PHP version is 5.6. The add-on does not support PHP 8.x yet. `Test <mailto:cart-addons@cscart.com>`_

.. |Contact us now| raw:: html

     <!--noindex--><a href="mailto:cart-addons@cscart.com" target="_blank" rel="nofollow">Contact us now</a><!--/noindex-->
